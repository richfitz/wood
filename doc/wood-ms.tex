...
% Here was the previous version (please delete if you prefer the
% above, merge the ideas, or delete the above and fix this one).
% 
% We now know a bit more about wood than Theophrastus: wood is thought
% to have originated in the early Devonian \citep[~400
% mya;][]{gerrienne2011simple}, and the evolution of woodiness across
% the phylogenetic tree depends on climate and differs among the major
% plant clades \citep{judd1994}, but basic questions still
% remain. [NOTE: We should fix this sentence as well as add a more
% thorough description of what exactly wood is]

% The transition to the next paragraph should now be clearer.

% Probably also should cite this:
% http://rspb.royalsocietypublishing.org/content/early/2010/07/07/rspb.2010.1004.short
% Though as far as I can see it spectacularly fails to even address
% the question in the title.
%
% You may also want to cite
% http://sysbio.oxfordjournals.org/content/early/2011/08/18/sysbio.syr080.abstract
% But this strongly contraticts the joppa one (coming up with 1.8-2.0
% million species).  So we probably have to adjust the text to note
% that the most recent estimates still differ by a factor of 4.
%
% Also see here
...
\begin{figure}[p]
  ...
  \caption{
    ...
    shaded rectangles; the upper polygon corresponds to the ``weak
    prior'' approach and the lower polygon corresponds to the ``strong
