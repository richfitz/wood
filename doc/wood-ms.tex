...
categories was reduced to a binary classification.  57 of
...
% WKC: I also don't like this paragraph as is
%
% I think this result is almost certainly because database errors turn homomorphic genera and orders into
% polymorphic genera and orders.  My take home message for the readers would be that we took a rather extreme way to characterize potential database/classification errors is 
% globally significant but still small relative to the effect of sampling bias.  I would also shift it down a bit in the discussion until after the sampling bias bit, as that 
% really is our main message
%
%% MWP: Agree with you both. See if you like what I have done here.
...
inferences made at a global scale is rather surprising. Two points are worth
nothing here. First, we reiterate
