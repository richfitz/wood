...
Most genera are either all-woody or all-herbacious.  Among the 748
...
herbaceous, even though odds are that most of them will be, so the
...
known states are woody) will underestimate the fraction of species that
...
model the other extreme of sampling, we used an approach where we
