...
The question posed by the title of this paper is a basic one, and it is
  ...
  some clades are exhaustively characterised, while others we know little--to--nothing about.  The potential effects of this bias are unknown but potentially large.  
  }
  % 
\item{
...
This bias also effects a whole array of different methods in ecological and evolutionary research \citep[e.g.,][]{ackerly2000taxon,nakagawa2008missing,pennell2013integrative} in addition to its well understood effects on conventional statistics.  In this case, taking the data at face--value, 
we would have greatly overestimated
the global percentage of woody species.  Inferring the global
frequency of any trait including would face the same problem.  For
example, the ecologically important traits of nitrogen--fixing, mycorrhizal symbioses and pollinator syndrome would face the same problem.  We have presented here a method for binary traits
