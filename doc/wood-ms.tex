...
% TODO: fixme on the [?]
%
% \textit{We are interested in whether expert opinion can substitute for
%   careful calculation}.
% %
% \citet{joppa2010} found that expert--estimate
% largely agreed with the model--estimated number of
% species in several Angiosperm groups \citep{joppa2010}, and we were
% interested in whether there was similar anecdotal knowledge for the
% relative prevalence of this key trait.


The motivation for including a survey alongside our empirical analysis was to determine whether a consensus
...
% RGF: Not sure if this goes here, or just before the survey
% discussion.  It probably need expanding in any case.
...
% Something extra to help lead into this.
...
%
% RGF: We should give examples of such methods here.  I know it will
% affect BiSSE (and related methods) and Mk.  Matt believes that it
% will affect BM.  Moles style global analyses.
%
