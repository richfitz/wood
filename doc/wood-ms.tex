...
\begin{figure}[p]
  ...
  \caption{Distribution of the percentage of woodiness among genera.
    ...
    differ in their bimodality (panel B). If we assume species are
    sampled with replacement from some pool, but having no prior on
    the fraction of woodiness within the pool, this results in a broad
    distribution with many polymorphic genera (blue lines).
