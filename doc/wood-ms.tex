...
ecosystems. The recognition of the fundamental
...
\begin{figure}[p]
  ...
  \caption{Distribution of the percentage of woodiness among orders of
    ...
    \citep{APG3} are not displayed. (There is some discrepancy 
    between the Zanne et al. and APG III phylogenies, most notably, 
    in the position of the Magnolids; however, the higher--level 
    relationships do not influence any of the actual analyses in this paper.)}
\label{fig:phylogeny}
\end{figure}
