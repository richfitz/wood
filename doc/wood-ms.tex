...
% RGF: Just guesses at something that might be useful
% But seriously: http://imgur.com/AHqKoc9
% Apparently we need 3-6 papers in case anybody faxes the paper to ISI
% web of science who will send smoke signals to libraries around the
% world!
...
\begin{abstract}
  % RGF: Or should we simply restate the title here to say:
  % "The question of what the percentage of woody species is is a
  % basic one;" (but more nicely written)?  Not sure what is clearer.
...
% MWP: Just got rid of the first "plants" as we already say "among terrestrial
% plants" below. You can change it back if you don't like it.
...
% MWP: Not really sure what else to do here. It seems fine.
...
% MWP: This discussion can wait until we get reviews back
% No need to worry about it at this point. Unclear what the status of Jeremy/Amy's 
% paper will be at the time this gets accepted somewhere.
...
% see anything on the website.  Dave added this, so chase up with him?

% MWP: I believe this is just a reference to the plant list. Just cite the list.
...
%
% MWP: I think the point about forests being species poor except in the forest
% is already covered by the hypothesized latitudinal gradient in opinions on woodiness
% and the point about shrubs being woody makes it sort of seem like we asked
% something of a trick question. Personally while I think Andrea is probably correct
% on both accounts, I would just as well leave them out. 
