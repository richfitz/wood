...
% nrow(tmp)           # 37961
% mean(tmp[,"V"] > 0) # 0.013
% TODO: Amy to check, but this lines up with the data set.
...
these cases are likely to biologically realistic but allowed us
allowed us to evaluate the maximal possible effect of mis--coding 
variable species.
%
% TODO: CHECK NUMBERS. DON'T SEEM TO ADD UP BUT PERHAPS I AM MISSING SOMETHING
...
% TODO: This is just jammed in here for now.
...
despite affecting a small minorority of species.  Coding all
...
%% TODO: THIS IS OUT OF PLACE HERE BUT I THINK IS IMPORTANT TO INCLUDE SOMEWHERE.
