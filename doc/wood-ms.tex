...
\item{
  ...
  Although we currently have data on XX\% of taxonomically resolved species across the globe, these data are not a random sample of global diversity: 
...
% 
We created a English-language survey (which we also translated into Portuguese) 
