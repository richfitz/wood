...
\begin{abstract}
  ...
  even if not formally documented in the peer-reviewed literature.  No
  such consensus existed, with estimates ranging from 1\% to 90\%
  (mean: 31.7\%).
  % 
...
\citep{judd1994}; that many different forms of pseudo-woody growth
...
plants (36,238 / 274,141 = 13\%), which will upwardly bias the global
