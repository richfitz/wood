...
species being woody.  Thus, it can be used as a type of taxonomically
--informed data--imputation.  Recently, two related approaches have
...
phylogenetically non-random distribtion of traits, the law of large
numbers will not apply, and that estimates from trait databases will
converge on the true value, even when they are fairly extensive.
%
