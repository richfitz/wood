...
\author{
Richard G. FitzJohn$^{*,1}$, Matthew W. Pennell$^{*,2,3}$, Amy E. Zanne$^{4}$,\\ Peter F. Stevens$^{5}$, David C. Tank$^{2,6}$, Jonathan M. Eastman$^{2}$,\\ \& William K. Cornwell$^{7}$
}
\date{}
\affiliation{\noindent
...
$^5$ Department of Biology, University of Missouri, St. Louis, MO 63166, U.S.A.\\
$^6$ Forest, Rangeland, and Fire Sciences Department and Stillinger Herbarium, College of Natural Resources, University of Idaho, Moscow, ID 83844, U.S.A.\\
$^7$ Department of Systems Ecology, VU University, 1081 HV Amsterdam, The Netherlands
}
% RGF: Why have a different running head to the main title?  They have
% the same number of characters!
\runninghead{The percentage of woody species}
...
%
Through large databases and synthetic research, a picture of global biodiversity is beginning to emerge, but especially with regard to global functional diversity, basic questions remain.   The woody/herbaceous divide is perhaps the most fundamental axis of functional diversity among plants.  We sought to address a very basic question: what percentage of the world's species are woody? Surprisingly, this question has never been comprehensively addressed.  We combined a plant functional trait database to date with two gap--filling approaches.  We estimate the percentage ``woodiness'' among the world's vascular plants to be between 45\% and 48\%.  We sought to determine whether a consensus answer to our question existed among botanists---even if not formally documented in the peer-reviewed literature. To investigate this, we coupled our analysis with a survey in which we posed our question to the broader community of botanists and other biologists.  We found that no expert consensus existed and that, on average, researchers underestimated the percentage of the world's flora that is woody. The results of our survey highlight that global datasets can show patterns at odds with conventional wisdom.  Global plant functional diversity is much woodier than we thought.  
\end{abstract}
...
woody and herbaceous categories \citep{theophrastus1916enquiry}. More recently, \cite{sinnott1915evolution} approached the question dividing both taxa and different geographic floras into the percentage woody and herbaceous.  

% An alternative here would be to structure this like (I've just
% arbitrarily jotted things down here).  Also may depend on a
% definition of "true" woodiness in the proceeding paragraph.  
...
%
However, surprisingly we have no idea about what percentage of species
are actually woody.
...
% suggests that researchers' intuitions regarding the percentage of
...
``wood''.  Functionally, not all wood is ``true wood'' (i.e., secondary thickness of the xylem).  However, in terms of their ecology, palms are``functionally woody'', having a long-lived above-ground stem and a tall stature.  

Theophrastus both recognized the fundamentally importance of the  distinction between woody and herbaceous plants, and that this distinction is in some cases difficult to make.   There are a number of species which are intermediate in form \citep{beaulieuHiddenRates}; in this dataset 633 species (1.3\%) were coded as variable.  For the formal analysis we excluded these species.
...
groups as observed by \citet[][ Figure \ref{fig:phylogeny}]{sinnott1915evolution}.  There are two major clades that are primarily herbaceous --- the monocots and Monilophyte (ferns).
...
NESCent, Other members of the working group. Rafael Maia. All the respondents to our survey. MWP was supported by a NESCent graduate fellowship.
...
\ref{fig:distribution-genera}).  \citep{sinnott1915evolution} 

Among the 748 genera with at least 10
