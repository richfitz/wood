...
In addition to improving an estimate of the mean, the methods in this paper
can also be used to generate a probability of each unobserved species being woody.
Thus, it can be used as a type of phylogenetically--informed data--imputation. 
Recently, two related approaches have been developed to do just this, 
both focusing on continuous traits \citep{Swenson2013, PEM}.  While their details
