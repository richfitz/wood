...
\begin{abstract}
  ...
  question has never been comprehensively addressed.
  % 
  We informally surveyed a the broad community of botanists to
  determine whether a consensus answer to our question existed among
  botanists --- even if not formally documented in the peer-reviewed
  literature.  No such consensus existed, with estimates ranging from
  1\% to 90\% (mean: 31.7\%).
  % 
  ...
  % (284732 - 49064 == 235668)
  235,668 species using two Monte Carlo approaches.  We estimated the
  proportion ``woodiness'' among the world's vascular plants to be
  between 45\% and 48\%.
  %
  This estimate is larger than 80\% of our expert estimates, most of
  whom substantially understimated the proportion of the world's flora
  that was woody.  The results of our survey highlight that global
  datasets can show patterns at odds with conventional wisdom.
\end{abstract}
...
% RGF: Looks like I've mis-remembered this.  I've reworded a bit to
% make it bounce along a bit better.
...
NESCent working group, so proceeded to investigate if a
general consensus among biologists existed.
% 
...
SUPPLEMENTAL TABLE CSV?.  Taxonomically, we
...
plants (36,238 / 274,141 = 13\%), which will upwardly bias the
...
The analysis script and full dataset are available on bitbucket
(reference to be added) and the exact version from this manuscript is
available via Dryad (reference to be added).


\section{Results and Discussion}

There was strikingly little consensis among researchers as to the
...
46.6--47.8\%).  This estimate is larger than 81\% of the estimates
from our survey.
...
woodiness, albeit now tempered by monophyly.  The relative paucity of genera with significant numbers of
...
%
A perhaps larger source of error is the likely nonrandom woodiness of
