...
``` {r distribution_raw,fig.cap="Distribution of simulated woodiness percentage"}
...
``` {r distribution_errors,fig.cap="Effect of recoding on woodiness estimates"}
...
``` {r fraction_by_genus,fig.cap="Fraction of woodiness by genus"}
fig.fraction.by.group(res.b, res.h, dat.g, "genus")
```
``` {r fraction_by_family,fig.cap="Fraction of woodiness by family"}
fig.fraction.by.group(res.b, res.h, dat.g, "family")
```
``` {r fraction_by_order,fig.cap="Fraction of woodiness by order"}
...
``` {r survey_by_latidude,fig.cap="Fitted latitude survey regression"}
...
``` {r survey_results,fig.cap="Survey results by predictor"}
...
``` {r survey_distribution,fig.cap="Distribution of survey results"}
...
``` {r variability,fig.cap="Variability by genus size"}
